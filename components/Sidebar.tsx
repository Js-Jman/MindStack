    ...
    <aside className="w-64 bg-white/80 border border-purple-100 rounded-2xl shadow-lg p-6 flex flex-col gap-2 sticky top-24 h-fit self-start">
      <nav className="flex flex-col gap-2">
        <SidebarSection title="Dashboard">
          <SidebarLink href="/dashboard/student">Overview</SidebarLink>
          <SidebarLink href="/dashboard/student">Progress summary</SidebarLink>
        </SidebarSection>

        <SidebarSection title="My Courses">
          <SidebarLink href="/dashboard/student">Courses</SidebarLink>
        </SidebarSection>
        ...
        <SidebarSection title="Quizzes / Exams">
          <SidebarLink href="/dashboard/student">Upcoming tests</SidebarLink>
          <SidebarLink href="/dashboard/student">Results</SidebarLink>
        </SidebarSection>
        ...
        <SidebarSection title="Profile / Settings">
          ...
          <SidebarLink href="/profile">Change password</SidebarLink>
        </SidebarSection>
      </nav>
    </aside>
  );
