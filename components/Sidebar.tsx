...
export default function Sidebar() {
  return (
    <aside className="w-64 bg-white/80 border border-purple-100 rounded-2xl shadow-lg p-6 flex flex-col gap-2 sticky top-24 h-fit self-start">
      <nav className="flex flex-col gap-2">
        <SidebarSection title="Dashboard">
          <SidebarLink href="/student">Overview</SidebarLink>
          <SidebarLink href="/student">Progress summary</SidebarLink>
        </SidebarSection>

        <SidebarSection title="My Courses">
          <SidebarLink href="/student">Courses</SidebarLink>
        </SidebarSection>

        <SidebarSection title="Assignments">
          <SidebarLink href="/assignments/due">Due tasks</SidebarLink>
          <SidebarLink href="/assignments/submissions">
            Submission status
          </SidebarLink>
        </SidebarSection>

        <SidebarSection title="Quizzes / Exams">
          <SidebarLink href="/student">Upcoming tests</SidebarLink>
          <SidebarLink href="/student">Results</SidebarLink>
        </SidebarSection>

        <SidebarSection title="Certificates">
          <SidebarLink href="/certificates/download">
            Downloadable certificates
          </SidebarLink>
        </SidebarSection>
